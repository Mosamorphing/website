      ...
      <section className="bio-section">
        <div className="bio-content">
          <div className="bio-text">
            <h2>"If you feel stuck & you don't know where to go, what to do & who to become, create a beautiful list of where you don't want to go, what you don't want to do & who you don't want to become. Make the list really clear because that right there is a pointer. Godspeed, my friend!"</h2>
            <p>
            ...
            <p>
            His versatile background includes successful stints in the fashion, fintech, design, education, communications, and blockchain industries, making him adept at navigating various sectors to deliver cutting-edge solutions that resonate with users.</p>
            <p>
              Combining creativity, technical acumen and a deep understanding of customer needs, he drives project, product and business excellence wherever you find him. </p>
          <p>
            He has been identified by many adjectives: Sage, Rebel, Genius, Psychologist, Counsellor; he answers them all. 
            </p>
            <p>
