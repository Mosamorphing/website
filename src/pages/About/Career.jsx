        ...
        <section className="w-[1400px] mx-[auto] xl:w-full xl:pl-[60px] lg:pl-[40px] 2xs:pl-[20px] flex">
          <div className="career-content w-[47%] lg:w-full">
            <div className="career-text mb-10">
              ...
              <p>
                DeSci NG (Dec 2024 till date): A community built on the ideals
              ...
              <p>
                ...
                startup with a digital product for creators. Mosadoluwa Fasasi
                worked as a generalist within a small team of builders. His role
                varied over time. Some of the designations were Scrum Master,
                Project Manager, and Content Associate. Mosadoluwa contributed
                to key organization decisions and helped achieve the milestone
