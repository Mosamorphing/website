...
const IntoTheMind = () => {
  return (
    <div className="blog-article">
      ...
      <h2>On Religion: <br/><br/> </h2>
      <p>
      They claimed pastors/men of God are liars and should never be trusted. Their belly is their God and they speak in the direction of what will profit them. Also, they said Muslims don’t even profit as much from the ruling power because they only fight based on ideas that contradict their faith. E.g removal of hijabs in schools. They admit that it was indeed a tight, unusual, and shaky election as PO won in places they never imagined, e.g Lagos, FCT and other major places they had high hopes for. They added that it was because of the engineering of men of God who put fear on their large members and laid curses on them that they must vote PO. They also added that their members only took their dogma and gave their numbers. Another of the 4 men quickly added “thank God for the G5 ooo, that was how we were able to pull through.”<br/><br/>
      They continued discussing on how tough the election was and how much the opposition tried to pull BAT down. One of them said they really dragged it with BAT. He made mention of some photoshopped images of BAT, how his hands shook in video conferences. Why is his hand not shaking again? He asked.<br/><br/>
      The Christian amongst them said “I know all the tricks of these Christians, after all, I’m a Christian. They are the ones that come out and say I need someone to give me 1 billion”. He also said that he has been taking his wife’s church offerings for himself (secretly of course, maybe because it serves him better). </p>
      <h2>On Influencers/Musicians: <br/><br/> </h2>
      <p>
      Folarin Falana (Falz) was the case study here. They seemed to have a consensus that his large involvement in rallying around the election, urging people to vote was all for selfish gains. They were sure it was only for their musical career. They all concluded that artists like Falz only Went in the direction of the majority because they fear for their careers/so they will not get canceled. Because if they get canceled, that is no stream on their music and if there are no streams, that means no money to flex.<br/><br/>
      Talks came around Dino Melaye and how he was also ‘funded’ in dollars by the Atiku group to influence and always raise a finger when he sensed foul plays.<br/><br/>
      </p>
      <hr></hr> <br></br>
      <p>
  It was a long journey and after listening to all of these quietly, I was drained. I was teased here and there but I replied no word. After some time, I regained myself and I attempted a critical resolve. I ended with a fearful and troubling question all the same. You’d agree it’s complicated when you read my critical resolve:<br/><br/>
  1. Every single tribe in Nigeria (including the minority tribes like Ijaw, Ibibio, Itsekiri, Igala and 250 more) ranging from Millennials to Baby Boomers have the above biases these 4 Yoruba men have, toward themselves and other tribes. You’ll agree with me that this has almost gotten us nowhere. We’re all in a giant rocking chair.<br/><br/>
</p>
<p>
