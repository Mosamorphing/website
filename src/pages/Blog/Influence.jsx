    ...
    <>
      <div className="blog-article">
        ...
        <p>
          ...
          what takes YOU there. If you can’t figure it out, at least count the
        ...
        <p>
          ...
          only know pieces and parts of the people around us/influences that
        ...
        <p>
          ...
          you’re going to take full responsibility for it. “yes, I heard it from
          this person or that person, but I TOOK THE DECISION”. When things go
          sideways or you see no result, you’re able to live with yourself. I
          think this is why we’ve come to hate motivational speakers and tag
          them liars. Also, it helps your heart in a lot of ways I don’t want to
          go into right now.
        </p>
        <p>
          But for context, I had a similar experience about a year ago and while
          I was very convinced that taking the decision wasn’t best for me at
          the moment, I listened to this external “advice” and yup, things went
        ...
        <p>
          ...
          that; in the process of knowing yourself, you’ve got to be honest with
          whatever you find, good or not so good.
        </p>
        <p>
          You’ve got to identify your leverages. The ones you have and the ones
          you do not have. If daddy is a reckless drunk and it affects the
          household income, that’s part of where you’re coming from. You’ve got
          to be honest with that. If mommy does all the hustling and manages to
          send you to a good school (a type of leverage), this is also part of
          where you’re coming from, be honest about that. If you’re the “Ada”
        ...
        <p>
          ...
          yourself, with the circumstances that make you you, you’ve got to be
          honest with yourself and the things you find.
        </p>
        <p>
          Recently, I found a hardcopy bible I owned in 2021 and at the back of
          it, I wrote 2 rules that guided my life at the time. The 2nd rule
          reads “Ask yourself the hard questions (to provocation)”.
        </p>
        <p>
          When people ask themselves the hard questions, they mostly find what
          they do not like and are not willing to confront. One of the things
          social media helps us with is that it allows many of us to escape
        ...
        <div className="blog-related-section">
          <p> Postscript: </p>
          <p>
            - “Ada” - first female child in Igbo land <br />- If you’re
            wondering what the 1st rule behind my bible was, it reads “Seek
            God”.
          </p>
